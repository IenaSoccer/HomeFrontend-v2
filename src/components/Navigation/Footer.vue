<template>
  <q-footer class="relative">
    <q-toolbar class="bg-primary text-[#f3f4f6] flex-col lg:flex-row pb-8">
      <div class="tenada w-full flex flex-row flex-wrap items-center justify-start sm:pl-16">
        <FooterFirm class="m-4" />
        <IMap />
      </div>
